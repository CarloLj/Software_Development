...
$json=array();
 ...
 if(isset($_GET["Nombredest"]) && isset($_GET["Apellidodest"]) && isset($_GET["Codigopostal"]) && isset($_GET["Colonia"])&& isset($_GET["Calle"])&& isset($_GET["Numeroext"])&& isset($_GET["Numeroint"])&& isset($_GET["Referencias"])&& isset($_GET["idcliente"])){
  ...
  $Update="UPDATE tarjeta SET Nombredest = '$Nombredest',Apellidodest = '$Apellidodest',Codigopostal = '$Codigopostal',Colonia = '$Colonia',Calle = '$Calle',Numeroext ='$Numeroext,Numeroint ='$Referencias ='$Referencias WHERE idcliente = $idcliente";
